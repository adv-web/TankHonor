...
public class TankHealth : PunBehaviour
{
    ...
    //[HideInInspector]
    public string team;         //玩家对象队伍
    //[HideInInspector]
    public bool isAlive;            //玩家对象是否存活
    //[HideInInspector]
    public int currentHP;           //玩家对象当前生命值
    //[HideInInspector]
    public bool invincible = false;//玩家对象是否无敌
    ...
    void Start()
    {
        ...
        colli = GetComponent<BoxCollider>();   //获取玩家对象胶囊碰撞体
